...
public class DiscoverTask extends AsyncTask<Void, Void, byte[]> {
    ...
    /**
     * A task for discovering Wifi lamps on the local network
    ...
    protected void onPostExecute(byte[] result){
        ...
        if(result == null){
            ...
            TableLayout buttonGrid = (TableLayout) rootView.findViewById(R.id.buttonTable);
    ...
    protected byte[] doInBackground(Void... params){
        ...
        try {
            ...
            while (!text.equals("acknowledged")) {
                ...
                if(count > Constants.CONNECTION_TIMEOUT){
                    throw new ConnectException("Cannot find and connect to any wifi lamps.");
                }
            }
